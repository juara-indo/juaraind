...
function App() {
  ...
  const addInvoice = async () => {
    ...
    try {
      ...
      await requestJson(`/admin/finance/${encodeURIComponent(selectedFinanceCandidate.candidate_id)}`, 'PUT', {
        ...invoiceForm,
