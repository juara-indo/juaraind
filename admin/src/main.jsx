...
function Icon({ name, size = 18 }) {
  const paths = {
    ...
    all: <><text x="12" y="15" textAnchor="middle" fontSize="8" fontWeight="700" fill="currentColor" stroke="none">ALL</text></>,
